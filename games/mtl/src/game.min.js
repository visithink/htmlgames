		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://game.nineying.cn";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://game.nineying.cn";
y.url = function() {
	return "http://game.nineying.cn?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://game.nineying.cn/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("小斯基—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("小斯基", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://game.nineying.cn"
			}, this);
